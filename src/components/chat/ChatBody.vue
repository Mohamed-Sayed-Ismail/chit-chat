...
const props = withDefaults(defineProps<Props>(), {
    ...
    isDark: false,
    isFront: true,
    sendMessageColor: '#dcf8c6',
    sendMessageTextColor: '#000000',
    receivedMessageColor: '#ffffff',
    receivedMessageTextColor: '#000000',
    usersListTextColor: '#000000',
    messageShadow: '#999999',
    hideEmoji: () => { },
    isGuest: false,
    isNewGuest: false,
    guestName: (value: any) => value,
    guestEmail: (value: any) => value,
    guestPhone: (value: any) => value,
    onNewGuestClearForm: () => { },
...
const audioControllerBackground = setBackground(props.sendMessageColor!, -15);
    ...
    <template>
        ...
        <div class="`relative scrollbar-hide  h-[550px] sm:max-h-[550px] w-full  border-opacity-55  overflow-scroll overflow-x-hidden scroll-m-0 `"
