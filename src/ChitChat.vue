...
import { FileMessage } from './class/FileMessage';
...
interface Props {
    ...
    isDark?: boolean;
    isNewGuest?: boolean;
    onNewGuestCloseForm?: () => void;
    onNewGuestClearForm?: () => void;
    onAddMessage?: (message: Message) => void;
}

const props = withDefaults(defineProps<Props>(), {
    users: () => [],
    supportUser: () => new User(0, '', '', '', false, '', []),
    isAnimation: true,
    isAudio: true,
    isFile: true,
    isGuest: false,
    isGuestAudio: true,
    isGuestFile: true,
    bodyBackground: '#929191',
    bodyBackgroundDark: '#2a2b2c',
    headerBackground: '#979696',
    headerBackgroundDark: '#222222',
    backgroundFooter: '#979696',
    backgroundDarkFooter: '#222222',
    shadowColor: '#000000',
    shadowColorDark: '#FFFFFF',
    textColorHeadTitleDark: '#000000',
    textColorHeadSubTitle: '#515151',
    textColorHeadSubTitleDark: '#8c8c8c',
    onGuestMessage: () => { },
    ...
    status: 'Online',
    statusOnline: '#066e10',
    statusOffline: '#c63737',
    statusOnlineDark: '#0889c5',
    statusOfflineDark: '#a41278',
    userName: '',
    fontFamily: 'Chalkboard',
    textColor: '#292929',
    textDarkTheme: '#bfbfbf',
    styleChat: 'leave',
    isFront: true,
    titleText: 'Right Click',
    subTitleText: 'For Integrated Solutions CO.LTD',
    textColorHeadTitle: '#1d1d1d',
    textDarkThemeHead: '#fff',
    fontFamilyFooter: 'san-serf',
    textColorFooter: '#000',
    textDarkThemeFooter: '#fff',
    textChatValueFooter: '',
    returnArrowColor: '#FFFFFF',
    returnArrowColorDark: '#5eb1fb',
    chatBodyFontFamily: 'Chalkboard',
    usersListTextColor: '#000',
    usersListTextColorDark: '#FFF',
    sendMessageColor: '#8cad9b',
    sendMessageColorDark: '#2f3345',
    receivedMessageColor: '#a1a1a1',
    receivedMessageColorDark: '#343434',
    sendMessageTextColor: '#000000',
    sendMessageTextColorDark: '#FFFFFF',
    receivedMessageTextColor: '#000',
    receivedMessageTextColorDark: '#fff',
    messageShadow: '#3f3f3f',
    messageShadowDark: '#bbbbbb',
    micColor: '#191b1f',
    onRecordColor: '#ff422d',
    micColorDark: '#bbc4d5',
    onRecordColorDark: '#ac0485',
    onRecorded: () => { },
    onMessageSent: () => { },
    onMessageReceived: () => { },
    isDark: false,
...
const hideEmoji = () => {
    ...
    const emojiElements = document.querySelectorAll('[id*="emoji"]');
    ...
    <div class="chat__face relative top-0 w-[400px] grid grid-cols-1">
            ...
            <div :id="chat__inner_id" class=" chat__inner ">
                <div v-if="getIsFront" class="absolute chat__front w-[400px] grid grid-cols-1">
                    <ChatHeader :logo="logo" :avatar="avatar" :status="status" :headerBackground="header_background"
                        ...
                        :shadow-color="shadow_color" :is-dark="isDark" :fontFamily="fontFamily" :isGuest="false" :hideEmoji="hideEmoji" @onBackToMain="onBackToMain" />
                ...
                <div v-if="!getIsFront" class="chat__face--back">
                    <ChatHeader :hideEmoji="hideEmoji" :logo="logo" :avatar="avatar" :status="getStatus(clickedUser)"
                        ...
                        :is-front="getIsFront" :shadow-color="shadow_color" :is-dark="isDark" :fontFamily="fontFamily" :isGuest="false"
        ...
        <div v-else>
            <ChatHeader key="" :logo="logo" :avatar="avatar" :status="status" :headerBackground="header_background"
                ...
                :shadow-color="shadow_color" :is-dark="isDark" :fontFamily="fontFamily" :is-guest="true" :hideEmoji="hideEmoji" @onBackToMain="onBackToMain" />
